...
--
-- Name: pex_test_1; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE pex_test_1 WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE pex_test_1 OWNER TO postgres;
